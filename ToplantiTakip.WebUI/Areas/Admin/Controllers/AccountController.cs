...
using ToplantiTakip.WebUI.Areas.Admin.Models.AccountModels;
...
namespace ToplantiTakip.WebUI.Areas.Admin.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController()
            : this(new UserManager<ApplicationUser>(new UserStore<ApplicationUser>(new ToplantiTakipContext())), new RoleManager<IdentityRole>(new RoleStore<IdentityRole>(new ToplantiTakipContext())))
        {
        ...
        {
            var users = UserManager.Users.Include(c => c.Roles).ToList();
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit(RegisterViewModel model, string[] selectedRoles)
        {
            ...
            PopulateAssignedRolesTag(model.ApplicationUser);
            return View(model);
        }
        //
