...
namespace ToplantiTakip.WebUI.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController()
            : this(new UserManager<ApplicationUser>(new UserStore<ApplicationUser>(new ToplantiTakipContext())))
        {
        }
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    ...
                    {
                        roleTags = new HashSet<string>(UserManager.GetRoles(user.Id),StringComparer.OrdinalIgnoreCase);
                        if (roleTags.Contains("admin"))
                        {
